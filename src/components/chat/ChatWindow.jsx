...
import { Check, CheckCheck, Send, Edit2, Trash2, Smile, X } from "lucide-react";
                        ...
                        {activeChat.type === 'direct' && (
                            <p className="text-xs">
                                {isPartnerTyping ? (
                                    ...
                                    <span className={activeChat.participant.status === 'Online' ? 'text-green-500' : 'text-gray-500'}>
                ...
                {loadingMessages ? (
                    ...
                    messages?.map((message) => {
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-2 max-w-[70%] relative">
                                        ...
                                        {isEditing ? (
                                            <div className="flex flex-col gap-2 min-w-[200px]">
                                                <input
                                                    ...
                                                    className="w-full bg-slate-900 border border-slate-700 rounded p-1 text-slate-100 focus:outline-none text-xs"
                                                    autoFocus
                                                />
